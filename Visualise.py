...
data = numpy.genfromtxt("Thisdata.csv", delimiter=",", skip_header=1)
...
import pygame
pygame.init()
Canvas = pygame.display.set_mode((1500,1000)) #pygame.RESIZABLE
...
for Pos in range(len(XPos)-1):
    pygame.draw.circle(Canvas,(0,0,0),((XPos[Pos]*0.4)+750,(YPos[Pos]*0.4)+500),1)
